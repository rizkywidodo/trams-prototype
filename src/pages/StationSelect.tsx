...
import { MapPin, ChevronRight, Train, ClipboardCheck } from "lucide-react";
      ...
      <header className="bg-primary text-primary-foreground">
        <div className="container max-w-2xl py-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Daily Check</h1>
          </div>
          <p className="text-primary-foreground/70 text-sm">
            Pilih stasiun untuk memulai inspeksi tenant
          </p>
        </div>
      </header>
          ...
          {filtered.map((station, i) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-4 rounded-lg border border-border bg-card p-4 text-left transition-all hover:border-primary/30 hover:shadow-sm group"
