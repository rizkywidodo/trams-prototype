...
export const TENANTS: Tenant[] = [
  ...
  { id: "t19", stationId: "cipete-raya", name: "KOPI KENANGAN" },
  { id: "t20", stationId: "cipete-raya", name: "INDOMARET" },
  { id: "t21", stationId: "haji-nawi", name: "ALFAMART" },
  { id: "t22", stationId: "haji-nawi", name: "MIXUE" },
  { id: "t23", stationId: "blok-a", name: "CHATIME" },
  { id: "t24", stationId: "blok-a", name: "LAWSON" },
  { id: "t25", stationId: "asean", name: "FORE COFFEE" },
  { id: "t26", stationId: "asean", name: "KOPI JAGO" },
  { id: "t27", stationId: "bendungan-hilir", name: "HOKBEN" },
  { id: "t28", stationId: "bendungan-hilir", name: "STARBUCKS" },
  { id: "t29", stationId: "setiabudi-astra", name: "SOLARIA" },
  { id: "t30", stationId: "setiabudi-astra", name: "POINT COFFEE" },
];
